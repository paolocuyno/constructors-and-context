...
let bob = new Employee('Bob','bob@gmail.com','01-02-98')
  ...
  */
  ...
  User.prototype.removeSavedPost=function(postId){
    let deletePost=this.savedPosts.findIndex((element) => {
      return element.id === postId
    })
    this.savedPosts.splice(deletePost,1)
  }
  ////////// PROBLEM 7 //////////
  ...
  // Code here
  User.prototype.changePostRating=function(changeId,newRating){
    let postRating=this.savedPosts.findIndex((element) =>{
      return element.id === changeId
    })
    this.savedPosts[postRating].rating=newRating
  }